    ...
    <div className="mx-auto max-w-6xl px-5 py-10 sm:py-14">
      <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground">Explore products from Jumia Kenya, add your choices to one MtaaMarket order, and select collection or home delivery at checkout.</p>
