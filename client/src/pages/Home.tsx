    ...
    <section className="market-hero-v2">
      <div className="market-hero-v2-inner">
        <div className="market-hero-v2-copy">
          ...
          <p className="market-hero-v2-description">Shop trusted local listings or explore a wider Jumia selection through MtaaMarket. Choose collection or home delivery and keep your order in one place.</p>
