...
const modeCopy: Record<AccountMode, { label: string; title: string; description: string }> = {
  link: { label: "Email link", title: "Sign in safely", description: "Use a secure email link. It does not create an order, publish a listing, or share your contact details." },
  password: { label: "Password", title: "Sign in with password", description: "Use the email and password you previously verified with MtaaMarket." },
  signup: { label: "Create account", title: "Create your account", description: "Verify your email before the account can sign in. A new account remains a buyer account only." },
