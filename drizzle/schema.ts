...
export const assistedOrders = mysqlTable("assisted_orders", {
  ...
  externalSourceDisclosure: text("externalSourceDisclosure"),
  externalSourceConfirmedAt: timestamp("externalSourceConfirmedAt"),
  externalSourceContentAttestedAt: timestamp("externalSourceContentAttestedAt"),
